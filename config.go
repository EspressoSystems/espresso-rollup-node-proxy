...
// "espresso_tag": ["safe", "finalized"]. Any string may be listed as a tag;
// validation only requires the list to be non-empty and free of empty
// strings. See proxy.Interceptor for the matching rules.
type Tags []string
...
func parseConfig() *Config {
	...
	pflag.StringSliceVar((*[]string)(&cfg.EspressoTags), "espresso-tag", cfg.EspressoTags, "block tags to intercept and resolve to the Espresso-finalized block number; any tag may be listed, comma-separated or repeated (e.g. safe,finalized)")
